...
contract MyEpicNFT is ERC721URIStorage {
    ...
    string[] firstWords = ["RATNEESH", "RAJ", "SHUBHAM", "ADARSH", "CHITRANSHU", "ANAND"];
    string[] secondWords = ["SHIVAM", "VAIBHAV", "TARANG", "RITESH", "GOURAV", "KARTIK"];
    string[] thirdWords = ["VERMA", "YADAV", "PAL", "TRIPATHI", "RANJAN", "TYAGI"];
